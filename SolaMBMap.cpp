...
LPSOLAMBMAP CSolaMBMap::GetLPMap(int index)
{
...
LPSOLAU32MAP CSolaMBMap::GetLPU32Map(int index)
{
...
SolaType CSolaMBMap::GetType(unsigned short addr)
{
...
SolaType CSolaMBMap::GetType(int index)
{
